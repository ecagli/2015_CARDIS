...
Under this assumption, the authors of \cite{SCAclassProbl} introduce in side-channel literature the {\em Inverse Participation Ratio} (IPR) and propose to use such a score to evaluate the eigenvectors {\em localization}. It is defined as follows:
\begin{equation}
