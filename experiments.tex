...
\hline 
\multicolumn{1}{|>{\columncolor[gray]{0.8}}c|}{Direct LDA} & EGV & & $\bigstar$& & \\
\hline 
...
\end{tiny}
\caption{Overview of extractors performances in tested situations. A $\bigstar$ denotes the best method, a ${\bf +}$ a method comparable to the best, a ${\bf -}$ a method showing lower performances. Methods introduced in this paper are highlighted.}
\end{table}