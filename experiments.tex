...
\end{tiny}
\caption{Overview of extractors performances in tested situations. $\bigstar = $ best method. ${\bf +} = $ performance comparable to the best method. ${\bf -} = $ lower performances.}
\end{table}