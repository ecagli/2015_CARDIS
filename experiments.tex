...
\end{tabular}
\end{tiny}
\captionof{table}{Overview of extractors performances in tested situations. A $\bigstar$ denotes the best method, a $+$ a method comparable to the best, a $-$ a method showing lower performances. Methods introduced in this paper are highlighted.}
\end{center}